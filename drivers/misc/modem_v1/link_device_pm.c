			...
			void (*cp_fail_fn)(struct modem_link_pm *))
{
	...
	*/
	...
	mif_info("%s: %s_irq#%d handler registered\n", pm->link_name,
		pm->cp2ap_wakeup_irq.name, pm->cp2ap_wakeup_irq.num);
